...
| `npm run update:server:dependencies`.         | updates `tools/ReFlex.TrackingServer/ClientApp/src/assets/data/package.json` with current npm dependicies and their version info |
