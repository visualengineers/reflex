...
namespace PointCloud.Benchmark.Interactivity
{
    public abstract class InteractionObserverBase : IInteractionObserver, IPerformanceReporter
    {
        ...
        protected Tuple<int, int>[] _fixedSamples = Array.Empty<Tuple<int, int>>();
        protected Tuple<int, int>[] _stochasticSamples = Array.Empty<Tuple<int, int>>();
        ...
        protected virtual List<Interaction> ConvertDepthValue(List<Interaction> interactions)
        {
        ...
        protected virtual List<Interaction> ComputeExtremumType(List<Interaction> interactions, Point3[][] pointsArray)
        {
        ...
        protected virtual void UpdatePerformanceMetrics(ProcessPerformance perfItem)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual float CalculateAverageDistance()
        {
            var sum = 0f;
